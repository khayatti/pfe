  ...
  <div class="py-4">
    <div class="row mx-3 mt-5">
      <div class="col-3">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title" style="color : black;">réserver un rendez-vous</h5>
            <p class="card-text">A partir de là, si vous désirez aller de l'avant avec le traitement, vous pourrez réserver un rendez-vous</p>
